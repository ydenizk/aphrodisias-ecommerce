...
async function ProductPage({ params: { id } }) {
  ...
  return (
    <div className="w-full  flex justify-center items-center py-16  mx-auto  ">
      <div className="flex gap-16 mx-auto justify-center items-center lg:gap-4 mmd:flex-col mmd:gap-0">
        <div className="w-[480px] bg-bgcolor h-[600px] relative border-8 border-bgcolor 
        lg:w-[460px] mmd:w-[540px] mmd:h-[480px] sm:w-[420px] sm:h-[400px]">
          <Image
            src={product.imgUrl}
            fill
            alt="cat"
        ...
        <div className="w-96  p-2 px-4 bg-bgcolor h-[600px] mmd:w-[540px] mmd:h-auto sm:w-[420px] xs:px-6">
          <p className="uppercase  font-light mb-8 mmd:mb-4 "> {product.catName} </p>
          <h1 className="text-2xl font-bold mb-4">{product.name} </h1>
          <p className="mb-8 font-light">{product.description}</p>
          <p className=" text-2xl font-light mb-2   ">€{product.price}.00 </p>
          <p className="text-sm mb-20 mmd:mb-10">inc. VAT, free delivery</p>
